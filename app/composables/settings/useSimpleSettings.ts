...
const FIELD_ALIASES: Record<string, BackendFieldRef> = {
    ...
    [refKey('provider', 'openaiApiKey')]: { section: 'provider', field: 'provider_openai_api_key' },
    [refKey('provider', 'openrouterApiKey')]: { section: 'provider', field: 'provider_openrouter_api_key' },
    [refKey('provider', 'customApiBase')]: { section: 'provider', field: 'provider_custom_api_base' },
    [refKey('provider', 'customApiKey')]: { section: 'provider', field: 'provider_custom_api_key' },
    [refKey('routing', 'chatProvider')]: { section: 'provider', field: 'routing_chat_provider' },
    [refKey('routing', 'chatModel')]: { section: 'provider', field: 'routing_chat_model' },
