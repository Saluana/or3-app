...
- [x] 1.1 Add runtime platform and mode types
...
- [x] 1.2 Add setup state store/composable
...
- [x] 1.3 Add Electron capability detection
...
- [x] 1.4 Gate host-mode UI by platform and mode
...
- [x] 2.1 Create setup shell route/component
...
- [x] 2.6 Implement setup progress/final step
...
- [x] 3.1 Define narrow preload API shape
...
- [x] 3.4 Add manual binary picker IPC
...
- [x] 3.5 Add Electron host config persistence
...
- [x] 6.1 Add host-mode sidebar status card
...
- [x] 6.3 Rename client-only pairing entry points in host mode
...
- [x] 6.4 Add mode switching settings
...
- [x] 12.5 Run remote-mode smoke test
