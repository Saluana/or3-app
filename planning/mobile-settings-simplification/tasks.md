...
- [ ] 1.1 Inventory current settings routes and links
...
- [ ] 1.2 Implement the final route contract
...
- [ ] 1.3 Define settings destination metadata if it reduces duplication
...
- [ ] 1.4 Inventory both dynamic section route shapes
...
- [ ] 2.1 Add `MobileSettingsHome.vue`
...
- [ ] 2.3 Add essential action cards
...
- [ ] 2.5 Add the Advanced Settings escape hatch
...
- [ ] 3.1 Convert current `/settings` content into Advanced Settings
...
- [ ] 3.2 Convert current raw advanced editor into Super Advanced Settings
...
- [ ] 3.3 Update labels and caution copy
...
- [ ] 3.4 Preserve section editor access
...
- [ ] 4.1 Update `SettingsSidebar.vue`
...
- [ ] 4.3 Avoid desktop capability loss
...
- [ ] 5.1 Add a Computer page entry point
...
- [ ] 5.2 Remove heartbeat from mobile Settings landing
...
- [ ] 5.3 Preserve `/settings/heartbeat`
...
- [ ] 6.1 Audit current composer model behavior
...
- [ ] 6.2 Label composer model choice as agent/run model where appropriate
...
- [ ] 6.3 Keep backend model roles in Advanced/Super Advanced
...
- [ ] 6.4 Avoid a second model picker system
...
- [ ] 7.1 Add a passkey status/action card to mobile settings
...
- [ ] 7.2 Reduce passkey setup friction
...
- [ ] 7.3 Preserve sensitive passkey safeguards
...
- [ ] 8.1 Apply Material-style hierarchy
...
- [ ] 8.3 Write final copy with real states
