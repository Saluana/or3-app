...
- [x] 1.1 Add version-compatible Tiptap dependencies
...
- [x] 1.2 Create shared editor command helpers
...
- [x] 1.3 Add Markdown conversion adapter
...
- [x] 2.1 Add file mention item types and search composable
...
- [x] 2.2 Build `FileMentionMenu.vue`
...
- [x] 2.3 Replace handcrafted mention parsing with Tiptap Mention/Suggestion
...
- [x] 3.1 Create `useChatCommands.ts`
...
- [x] 3.2 Build `SlashCommandMenu.vue`
...
- [x] 3.3 Wire slash suggestions into `AssistantComposer.vue`
...
- [x] 3.4 Implement safe command behaviors
...
- [x] 4.1 Add `GET /internal/v1/files/read`
...
- [x] 4.2 Add `PUT /internal/v1/files/write`
...
- [x] 4.3 Add prompt folder ensure support
...
- [x] 4.4 Add backend file API tests
...
- [x] 5.1 Add `useComputerTextFiles.ts`
...
- [x] 5.2 Add editor route state helpers
...
- [x] 6.1 Create `MarkdownEditor.vue`
...
- [x] 6.2 Add toolbar and copy actions
...
- [x] 6.3 Add conflict and error UI
...
- [x] 6.5 Integrate editor with file browser
...
- [x] 7.2 Create `/prompts` gallery page
...
- [x] 7.3 Reuse `MarkdownEditor` for prompt files
...
- [x] 7.4 Add chat integration for prompts
...
- [x] 8.3 Add route/navigation entry points
