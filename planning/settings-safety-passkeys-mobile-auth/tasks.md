...
- [ ] 1.1 Choose the production RP ID and domain strategy
...
- [ ] 1.3 Choose native mobile passkey implementation path
...
- [ ] 1.4 Define route sensitivity matrix
...
- [ ] 2.1 Extend OR3 Intern config types
...
- [ ] 2.2 Add configure fields for auth settings
...
- [ ] 2.3 Validate RP ID and origins
...
- [ ] 3.2 Implement passkey credential store
...
- [ ] 3.4 Implement auth session store
...
- [ ] 4.1 Add WebAuthn backend dependency
...
- [ ] 4.2 Implement registration begin/finish
...
- [ ] 4.3 Implement login begin/finish
...
- [ ] 4.4 Implement step-up begin/finish
...
- [ ] 4.5 Implement passkey management APIs
...
- [ ] 5.1 Extend service auth middleware
...
- [ ] 5.2 Add structured auth challenge errors
...
- [ ] 6.2 Add WebAuthn utility module
...
- [ ] 6.5 Add secure token storage wrapper
...
- [ ] 6.6 Update API wrapper credential selection
...
- [ ] 7.4 Improve pairing/device copy
...
- [ ] 7.6 Add advanced settings escape hatch
  - Keep current section editor available from Advanced.
  - Requirements: 1.4

## 8. Add Mobile Platform Support

- [ ] 8.1 Add iOS Associated Domains assets/config
...
- [ ] 8.2 Add Android Digital Asset Links assets/config
...
- [ ] 8.5 Add degraded security state UI
