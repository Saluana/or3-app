...
- [x] 2.2 Create reusable UI primitives
...
- [x] 2.3 Build `AppShell.vue`, `AppHeader.vue`, and `BottomNav.vue`
...
- [x] 2.4 Create primary route placeholders
...
- [x] 3.2 Implement local cache composable
...
- [x] 3.3 Add token storage abstraction
...
- [x] 4.3 Add SSE parsing utilities
...
- [x] 5.1 Build first-run connection screen
...
- [x] 5.2 Implement pairing request flow
...
- [x] 5.3 Implement pairing exchange and host storage
...
- [x] 6.1 Create chat session state
...
- [x] 6.2 Port simplified composer action registry
...
- [x] 6.3 Port simplified chat input bridge
...
- [x] 6.4 Build `AssistantComposer.vue`
...
- [x] 6.5 Build message rendering components
...
- [x] 6.6 Implement `useAssistantStream`
...
- [x] 7.3 Build agent list and detail views
...
- [x] 8.1 Implement health/readiness/capabilities composables
...
- [x] 8.2 Build Computer overview page
...
- [x] 9.1 Design and document file API contract in `or3-intern`
...
- [x] 9.2 Implement root-scoped file listing backend
...
- [x] 9.3 Implement file metadata and download backend
...
- [x] 9.4 Implement upload and directory operations backend
...
- [x] 9.5 Add backend tests for file API
...
- [x] 10.1 Implement `useComputerFiles`
...
- [x] 10.2 Build file browser components
...
- [x] 11.1 Design and document terminal API contract in `or3-intern`
...
- [x] 11.2 Implement bounded terminal session backend
...
- [x] 11.3 Implement terminal stream/input/resize/close backend
...
- [x] 11.4 Add backend tests for terminal API
...
- [x] 12.1 Implement `useTerminalSession`
...
- [x] 12.2 Build `TerminalPanel.vue`
...
- [x] 13.4 Add approval notifications/badges
...
- [x] 14.3 Build generic configure section editor
...
- [x] 15.1 Implement embeddings and scope composables
...
- [x] 15.3 Implement audit composable and Trust UI
...
- [x] 16.1 Build Add page/action hub
...
- [x] 16.2 Add file-to-chat and agent-to-chat flows
...
- [x] 19.2 Document v1 backend extension contracts
...
- [x] 19.3 Create v1 release checklist
